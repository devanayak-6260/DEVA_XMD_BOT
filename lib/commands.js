...
const autoreply=require('../commands/autoreply'), setreply=require('../commands/setreply'), delreply=require('../commands/delreply');
...
const knownFromMe=new Set([
  ...
  'fullpp','url','owner','runtime','on','off','autoreact','setreact','autoreply','setreply','delreply','resize','compress','png','jpg',
  ...groupCmds
]);
...
module.exports=async(sock,msg)=>{
  try{
    ...
    switch(cmd){
      ...
      case 'autoreply': return autoreply(sock,msg,args);
      case 'setreply': return setreply(sock,msg,args);
      case 'delreply': return delreply(sock,msg,args);
      case 'on':
